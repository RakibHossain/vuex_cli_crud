<template>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        <div class="form">
          ...
          <input v-model="name" class="form-control mb-2 mr-sm-2" id="field-name" placeholder="Type a name" />
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <form v-on:submit.prevent="formValid && mutate()">
              ...
              <input v-model="newMessage" class="form-control mb-2 mr-sm-2" id="field-message" placeholder="Type a message" />
            </form>
    ...
    <div class="image-input">
      ...
      <input type="file" accept="image/*" id="field-image" required @change="onUploadImage" />
    </div>
